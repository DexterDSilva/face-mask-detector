...
Dexters-MacBook:face-mask-detector dexterdsilva$ tree --dirsfirst --filelimit 12
.
├── dataset
...
├── generate-mask-images (from https://github.com/prajnasb/observations/tree/master/mask_classifier/Data_Generator)
│   └── observations-master
│       ├── experiements
│       │   ├── data (the images have been deleted to save space bcos they are already in dataset above)
│       │   │   ├── with_mask [690 entries exceeds filelimit, not opening dir]
│       │   │   └── without_mask [686 entries exceeds filelimit, not opening dir]
│       │   └── dest_folder
│       │       ├── test
